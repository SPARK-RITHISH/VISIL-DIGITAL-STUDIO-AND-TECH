    ...
    <div>
      ...
      <main className="container space-y-16 py-16">
        <section className="space-y-6">
          <p className="text-sm uppercase tracking-[0.3em] text-brand-200">Register</p>
          <h1 className="section-title">Create your customer account</h1>
        </section>
        <section className="rounded-3xl border border-white/10 bg-white/5 p-10 shadow-[0_30px_90px_rgba(0,0,0,0.25)]">
          <form className="grid gap-6">
            ...
            <button type="submit" className="btn-primary w-max">Register</button>
          </form>
        </section>
      </main>
      <Footer />
